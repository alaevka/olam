...
/**
 * Handles the creation for table `otherads_categories`.
 */
class m160920_055202_create_otherads_categories_table extends Migration
{
    const TABLE_NAME = '{{%ads_categories}}';
