<div class="col-md-12">
<div class="row realty-item <?= ($index % 2) ? 'odd' : 'even' ?>" onclick="location.href='#';">
	<div class="col-xs-1"><?= date('d.m.Y', $model->created_at) ?></div>
	<div class="col-xs-1"><img class="img-responsive" src="/uploads/ads/<?= $model->_getImage() ?>"></div>
	<div class="col-xs-1"><?= $model->rooms_count ?></div>
	<div class="col-xs-1"><?= $model->location->location ?></div>
	<div class="col-xs-1"><?= $model->location_raion ?></div>
	<div class="col-xs-1"><?= $model->location_street ?></div>
