...
<div class="row">
    <div class="col-md-12 central-content" id="central-content">
        <h1><?= Yii::t('app', 'user.profile') ?> <span class="pull-right user-email-login"><?= Yii::$app->user->identity->email ?></span></h1>
    </div>
    <div class="col-md-3">
        <?= $this->render('_menu') ?>
    </div>
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    <div class="col-lg-offset-3 col-lg-9">
                        <?= Html::submitButton(Yii::t('user', 'Save'), ['class' => 'btn btn-blue']) ?><br>
                    </div>
                </div>
