...
$this->title = Yii::t('app', 'user.realty_objects');
$this->params['breadcrumbs'][] = $this->title;
?>

<div class="row">
    <div class="col-md-12 central-content" id="central-content">
        <h1><?= Yii::t('app', 'user.realty_objects') ?> <span class="pull-right user-email-login"><?= Yii::$app->user->identity->email ?></span></h1>
    </div>
    <div class="col-md-3">
        <?= $this->render('_menu') ?>
    </div>
