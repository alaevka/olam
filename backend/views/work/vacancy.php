	...
	<div class="panel-heading">
		...
		<div class="panel-options">
			<ul class="nav nav-tabs">
				<li class="active">
					<a href="#tab1" data-toggle="tab">Список вакансий</a>
				</li>
				
				<li class="">
					<a href="<?= Url::to(['/work/createvacancy']) ?>"><i class="entypo-plus-squared"></i> Добавить вакансию</a>
				</li>
			</ul>
		</div>
	</div>
			            ...
			            [
			                ...
			                'buttons' => [
			                    ...
			                    'delete' => function ($url, $model) {
			                        return Html::a('<i class="glyphicon glyphicon-trash"></i>', Url::to(['/work/deletevacancy/', 'id' => $model->id]), [
