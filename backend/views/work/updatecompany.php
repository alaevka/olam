	...
	<div class="panel-heading">
		...
		<div class="panel-options">
			<ul class="nav nav-tabs">
				<li class="active">
					<a href="#tab1" data-toggle="tab">Изменение компании</a>
				</li>
				<li class="">
					<a data-method="post" href="<?= Url::to(['/work/deletecompany/', 'id' => $model->id]) ?>"><i class="entypo-minus-squared"></i> Удалить компанию</a>
				</li>
				<li class="">
