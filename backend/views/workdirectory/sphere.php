	...
	<div class="panel-heading">
		...
		<div class="panel-options">
			<ul class="nav nav-tabs">
				...
				<li class="">
					<a href="<?= Url::to(['/workdirectory/create', 'model_name' => 'WorkSpheres']) ?>"><i class="entypo-plus-squared"></i> Добавить позицию</a>
				</li>
			</ul>
		</div>
	</div>
			            ...
			            [
			                ...
			                'buttons' => [
			                    'update' => function ($url, $model) {
			                    	$url = Url::to(['/workdirectory/update/', 'id' => $model->id, 'model_name' => 'WorkSpheres']);
			                    ...
			                    'delete' => function ($url, $model) {
			                    	$url = Url::to(['/workdirectory/delete/', 'id' => $model->id, 'model_name' => 'WorkSpheres']);
