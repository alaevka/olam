...
use common\models\SearchNewsMaterial;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;


class NewsmaterialController extends Controller
{
    ...
    {
        $searchModel = new SearchNewsMaterial;
    ...
    {
        if (($model = NewsMaterial::findOne($id)) !== null) {
            return $model;
        } else {
