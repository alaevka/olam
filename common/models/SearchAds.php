...
class SearchAds extends Ads
{
    ...
    public function rules()
    {
        return [
            [['id'], 'integer'],
            [['location_city', 'rlty_action', 'rooms_count', 'area_from', 'area_to', 'price_from', 'price_to', 'level_from', 'level_to', 'location_raion', 'location_street', 'house_type', 'house_material', 'build_type', 'is_active'], 'safe'],
        ];
    }
